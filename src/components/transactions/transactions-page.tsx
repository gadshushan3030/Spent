          ...
          {FILTER_OPTIONS.map((opt) => {
            ...
            return (
              <button
                ...
                className={
                  active
                    ? "rounded-full glass-strong px-4 py-1.5 text-xs font-medium text-foreground transition-colors"
                    : "rounded-full border border-transparent px-4 py-1.5 text-xs font-medium text-muted-foreground transition-colors hover:text-foreground"
                }
              >
                {opt.label}
              </button>
